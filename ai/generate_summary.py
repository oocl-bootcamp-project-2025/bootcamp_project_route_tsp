    ...
    try:
        ...
        try:
            ...
            if "CONTEXT" in os.environ and "requests" in os.environ.get("CONTEXT", ""):
                fallback = """
                    ISSUE: AI summary service unavailable (requests error)
                    CAUSE: Unable to connect to Azure OpenAI API
                    FIX: Check network connectivity and Azure OpenAI service status
            ...
            if "STATUS" in str(e):
                ...
                fallback = """
                    ISSUE: AI summary generation failed (requests error)
